...
pub const BOMB_EXPLOSION_RADIUS: f32 = 180.0; //MUST BE LESS THAN ALL MONSTER HEARING DISTANCES
...
pub const BOMB_SPAWN_INITIAL_INTERVAL: f32 = 7.0;
pub const BOMB_SPAWN_INTERVAL_DELTA: f32 = 0.25;
pub const BOMB_SPAWN_MINIMAL_INTERVAL: f32 = 1.0;
